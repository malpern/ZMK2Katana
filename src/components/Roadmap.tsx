  ...
  return (
    <div className="glass-card p-6 flex flex-col h-full">
      <div className="flex justify-between items-start mb-4">
        ...
        <span
          className={`px-2 py-1 rounded-full text-xs flex items-center ${statusClasses[status]}`}
        >
...
const Roadmap = () => {
  return (
    <section
      id="roadmap"
      className="py-20 bg-keyboard-dark relative overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-keyboard-text/80 leading-relaxed mb-12">
            We're just getting started with this project. Here's where we're
            headed next.
          </p>
        </div>
