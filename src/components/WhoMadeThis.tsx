            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="text-left space-y-4">
                ...
                <p className="text-keyboard-text/80 leading-relaxed">
                  Design & Product. Chief Product Officer at SmirkHealth, Prev
                  Sr Director @Instacart, Prior: Head of Design @Venmo,
                  @Facebook, @Medallia, @LinkedIn, @Yahoo, @eBay, @Ixda founding
                  board, CMU
                </p>
