...
const WhatToolDoes = () => {
  return (
    <section className="py-20 bg-keyboard-dark/80" id="what-this-tool-does">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flow-diagram mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-2 relative">
              {/* Step 1 */}
              <Card className="glass-card border-0 overflow-visible group hover:bg-keyboard-primary/5 transition-all duration-300">
                <CardContent className="p-6 flex flex-col items-center text-center">
                  <div className="h-16 w-16 rounded-full bg-keyboard-dark flex items-center justify-center mb-4 border border-keyboard-primary/20 group-hover:border-keyboard-primary transition-colors">
                  ...
                  <div className="text-sm text-keyboard-text/50 mt-2">
                    No coding required
                  </div>
                </CardContent>
              </Card>
              ...
              <div className="hidden md:flex items-center justify-center">
                <ArrowRight className="h-10 w-10 text-keyboard-primary/50" />
              </div>
              ...
              <div className="flex md:hidden justify-center w-full my-2">
                <ArrowRight className="h-8 w-8 text-keyboard-primary/50 transform rotate-90" />
              </div>
              <div className="flex md:hidden justify-center w-full my-2">
                <ArrowRight className="h-8 w-8 text-keyboard-primary/50 transform rotate-90" />
              </div>
            ...
            <div className="mt-12 text-center">
              <div className="bg-keyboard-primary/10 text-keyboard-primary font-semibold px-6 py-3 rounded-lg inline-block">
