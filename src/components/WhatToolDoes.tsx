          ...
          <div className="glass-card p-8 mb-12">
            <ul className="space-y-6">
              ...
              <li className="flex items-start">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-semibold text-keyboard-text">
                    Translates advanced keyboard features
                  </h3>
                  <p className="text-keyboard-text/70 mt-1">
                    <a
                      href="https://zmk.dev/docs/keymaps"
                      target="_blank"
                    ...
                    , and{" "}
                    <a
                      href="https://zmk.dev/docs/keymaps/behaviors/macros"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-keyboard-primary hover:underline"
                    >
              ...
              <li className="flex items-start">
                ...
                <div className="text-left">
                  <h3 className="text-xl font-semibold text-keyboard-text">
                    Works with Kanata's live reload
                  </h3>
                  <p className="text-keyboard-text/70 mt-1">
            ...
            <div className="mt-12 text-center">
              <div className="bg-keyboard-primary/10 text-keyboard-primary font-semibold px-4 py-2 rounded-lg inline-block mb-8">
                Edit your firmware layout → Convert to Kanata → Use it instantly
                on macOS or Linux
              </div>
