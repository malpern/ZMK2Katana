...
const macTools = [
  {
    name: "Raycast",
    description:
      "Powerful launcher that lets you control your tools with a few keystrokes",
    image:
  ...
  },
  {
    name: "Homerow",
    description:
      "Keyboard-driven UI navigation for macOS. Reduce your dependency on the mouse.",
    image:
      "https://www.homerow.app/_next/image?url=%2Fapp-icon.png&w=640&q=100",
  ...
  },
  {
    ...
    image:
      "https://modedesigns.com/cdn/shop/files/sixtyfive-2024-stacked-header.jpg?v=1722901512&width=1540",
  ...
  },
  {
    ...
    image:
      "https://www.mercurynews.com/wp-content/uploads/2023/12/SJM-L-KEYBOARD-4.jpg?w=620",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-keyboard-text/80 max-w-2xl mx-auto mb-12">
            Looking for more ways to enhance your Mac keyboard experience? Check
            out these powerful tools and resources.
          </p>
                ...
                <div className="group relative bg-gray-900/60 rounded-lg overflow-hidden border border-white/10 hover:border-keyboard-primary/50 transition-all h-full">
                  <div className="aspect-video overflow-hidden bg-gray-800">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        target.src =
                          "https://placehold.co/400x200/1e1e1e/fafafa?text=" +
                  ...
                  <div className="p-5">
                    <div className="flex items-center justify-between mb-2">
                      <h3 className="font-bold text-lg text-keyboard-text">
                        {tool.name}
                      </h3>
