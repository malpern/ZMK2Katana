        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-block bg-keyboard-primary/10 px-4 py-1.5 rounded-full mb-6">
            <span className="text-keyboard-primary text-sm font-medium">
              Announcing ZMK → Kanata Converter
            </span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-keyboard-text/80 mb-10 leading-relaxed">
            Make your existing keyboard as powerful as a custom mechanical{" "}
            <span className="font-semibold">without</span> having to edit and
            flash firmware, with this ZMK to Kanata converter.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            ...
            <Link to="/user-guide">
              <Button
                variant="outline"
                className="border-keyboard-secondary text-keyboard-secondary hover:bg-keyboard-secondary/10 px-8 py-6 text-lg w-full sm:w-auto flex items-center gap-2"
              >
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 rounded-b-xl backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-sm font-medium text-keyboard-text/90">
                    Keyboard Superpower
                  </span>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="glass-card overflow-hidden flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <div className="text-left">
                  <h3 className="text-lg font-bold text-keyboard-text mb-2">
                    Step 1: Create your ZMK keymap
                  </h3>
                  <p className="text-sm text-keyboard-text/80">
                    Design your custom keyboard layout in{" "}
                    <a
                      href="https://nickcoutsos.github.io/keymap-editor/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-keyboard-primary hover:underline"
                    >
                      Nick's Keymap Editor
                    </a>
                    , the visual editor for ZMK-powered keyboards.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card overflow-hidden flex flex-col">
              ...
              <div className="p-4 flex-1 flex flex-col">
                ...
                <div className="text-left">
                  <h3 className="text-lg font-bold text-keyboard-text mb-2">
                    Step 2: Run it on your Mac with Kanata
                  </h3>
                  <p className="text-sm text-keyboard-text/80">
                    Convert your ZMK configuration to{" "}
                    <a
                    ...
                    , the powerful keyboard customization tool that brings your
                    favorite firmware features to macOS.
                  </p>
                </div>
              </div>
            </div>
