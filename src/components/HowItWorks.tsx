      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <div className="inline-block bg-keyboard-highlight/10 px-4 py-1.5 rounded-full mb-6">
            <span className="text-keyboard-highlight text-sm font-medium">
              How It Works
            </span>
          </div>
          ...
          <p className="text-lg text-keyboard-text/80 leading-relaxed">
            The converter works as a comprehensive translation layer between two
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <CollapsibleTrigger className="w-full">
              <div
                className={`glass-card p-6 transition-all duration-300 hover:shadow-lg hover:border-keyboard-primary/30 ${isExpanded ? "mb-8 border-keyboard-primary/40" : ""}`}
              >
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div className="w-full md:w-2/3 text-left">
                    <h3 className="text-2xl font-semibold mb-2">
                      Discover How the Converter Works
                    </h3>
                    <p className="text-keyboard-text/70 mb-4">
                      Our conversion process transforms ZMK keymap files into
                      Kanata configurations through a series of precise
                      transformations.
                    </p>
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center">
                    <div className="flex-1 order-2 md:order-1 md:text-right md:pr-10 mt-6 md:mt-0">
                      <h3 className="text-xl font-semibold mb-2">
                        Parse ZMK Configuration
                      </h3>
                      <p className="text-keyboard-text/70 leading-relaxed">
                        The converter reads your ZMK .keymap file (Device Tree
                        Source) or configuration generated through the ZMK GUI
                        and builds an in-memory representation.
                      </p>
                    </div>
  ...
  params: {
    ...
    bindings: ["kp", "kp"]
                    ...
                    <div className="flex-1 order-3 md:pl-10 mt-6 md:mt-0">
                      ...
                      <p className="text-keyboard-text/70 leading-relaxed">
                        Converts the ZMK structures into a normalized
                        Intermediate Representation (IR) that can be reasoned
                ...
                <div className="mb-16 md:mb-24 relative z-10">
                  <div className="flex flex-col md:flex-row items-start md:items-center">
                    <div className="flex-1 order-2 md:order-1 md:text-right md:pr-10 mt-6 md:mt-0">
                      ...
                      <p className="text-keyboard-text/70 leading-relaxed">
                        Translates the normalized behaviors into their Kanata
                        equivalents, using pattern matching to find the closest
                        analogues.
                      </p>
                    </div>
                    <div className="bg-keyboard-primary text-white w-8 h-8 rounded-full flex items-center justify-center font-bold order-1 md:order-2 z-20">
...
deflayer(base
  @mt_a @mt_s...
                    ...
                    <div className="flex-1 order-3 md:pl-10 mt-6 md:mt-0">
                      ...
                      <p className="text-keyboard-text/70 leading-relaxed">
                        Outputs a complete, well-formatted Kanata configuration
                        file that preserves the behavior of your original ZMK
                        setup.
                      </p>
                    </div>
                  </div>
