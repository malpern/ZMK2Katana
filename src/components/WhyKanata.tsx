        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <CollapsibleTrigger className="w-full">
              <div className={`glass-card p-6 transition-all duration-300 hover:shadow-lg hover:border-keyboard-primary/30 ${isOpen ? 'mb-8 border-keyboard-primary/40' : ''}`}>
                <div className="flex flex-col md:flex-row items-center gap-6">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-32 h-32 relative">
                          ...
                          <img
                            ...
                            style={{
                              filter: 'drop-shadow(0 0 8px rgba(124, 58, 237, 0.5)) opacity(0.85)'
                            }}
                          />
                  ...
                  <div className="w-full md:w-2/3 text-left">
                    <h3 className="text-2xl font-semibold mb-2">Why Kanata Instead of Karabiner-Elements?</h3>
                    <p className="text-keyboard-text/70 mb-4">
                      Discover why our converter targets Kanata instead of the popular Karabiner-Elements for translating ZMK configurations.
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-keyboard-highlight text-sm">Compare the two approaches</span>
